<template>
    <nav
      class="bg-transparent border-gray-200 px-2 sm:px-4 py-2.5 rounded"
    >
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="flex items-center md:order-2">
          <a href="https://instagram.com/gavrielijlal" target="_blank">
            <button
              type="button"
          ...
          <a href="https://www.linkedin.com/in/gavrelijlal/" target="_blank">
            <button
              type="button"
              class="flex mr-3 text-sm  md:mr-0 "
              id="user-menu-button"
          ...
          <a href="https://github.com/SupraKuning" target="_blank">
            <button
              type="button"
              class="flex mr-3 text-sm  md:mr-0 "
              id="user-menu-button"
        ...
        >
          ...
          >
            <li>
              <a
                href="#"
                class="block py-2 pr-4 pl-3 text-white bg-white-700 rounded md:bg-transparent md:text-white-700 md:p-0"
                aria-current="page"
                >Home</a
              >
            </li>
            <li>
              <a
                href="#"
                class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-white-50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0"
                >Portfolio</a
              >
            </li>
          </ul>
