    ...
    <div class="container my-24 px-6 mx-auto">
        <div class="px-6 py-12 md:px-12 text-center lg:text-left rounded-lg shadow-2xl ">
            ...
            <div class="grid lg:grid-cols-2 gap-12 flex items-center">
                ...
                <div class="mt-12 lg:mt-0 text-white text-3xl font-light">
                    <p>Debat Calon Ketua Umum dan Calon Wakil Ketua Umum Himpunan Mahasiswa Informatika Universitas Jember Periode 2021-2022 HMIF Election Vote 2021 berbentuk live streaming melalui platform zoom.</p>
                </div>
            </div>
            </div>
        </div>
